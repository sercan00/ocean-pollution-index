...
function colour(s){{
  ...
  if(s<100) return '#c0392b';
  if(s<150) return '#8e1010';
  if(s<250) return '#5e0a0a';
  return '#2a0a2a';
}}
function grade(s){{
...
function rad(s){{
  ...
  if(s<50) return 17; if(s<70) return 22;
  if(s<100) return 27; if(s<150) return 32;
  if(s<250) return 38; return 44;
}}
